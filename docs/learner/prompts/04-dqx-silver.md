...
After approval, create `configs/dqx-rules.yaml`, `pipelines/src/silver.py`, and
`pipelines/src/outputs.py`; extend the cumulative local SDP specification. DQX must be the only domain
